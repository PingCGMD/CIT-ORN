...
for i in liste_name:
    ...
    for line in lines:
        if '    1    P2     1   CIT    BB     1  0.0000 ; C' in line:
            ...
            out = "PEG114_"+i 
            name = "PEG114_"+seq
            os.system("polyply gen_itp -f {}  MA.itp PEG_114_OH.itp MA-CIT.ff -seq {}:1 MA:1 PEGOH:1 -o {} -name {}".format(i,seq,out,name))

        if '    1    P2     1   ORN    BB     1  0.0000 ; C' in line:
            seq = i.split(".")[0]
            out = "PEG114_"+i
            name = "PEG114_"+seq
            os.system("polyply gen_itp -f {}  MA.itp PEG_114_OH.itp MA-ORN.ff -seq {}:1 MA:1 PEGOH:1 -o {} -name {}".format(i,seq,out,name))
